...
```{r}
stat <- coef(summary(mod))[,3]
pval <- pt(stat, 7, lower.tail=F)
pval*2
```
...
```
**the result of `t.test(women$los, men$los, var.equal=T)` matches the p-value from `summary(mod)`**
